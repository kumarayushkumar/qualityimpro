      ...
      <div className="about__content container">
        <div className="about__content--header">
          ...
          <p>
            ...
            comprehensive one-stop solution to alleviate your struggles, guiding
            your brand to swim alongside the industry giants. We understand the
            significant investment involved in the food and hospitality sector,
            and our expertise ensures that your time and money are wisely spent.
            Whether it's optimizing staff management, boosting revenues, or
            implementing effective cost-cutting strategies, we are here to
            provide the knowledge and guidance you need for success.
          </p>
          <p>
            ...
            flavors. Explore our curated selection that promises not just meals
